...
Get a list of favorite tune IDs for a specific user.

**Parameters:**
- `user_id` (path): The unique identifier for the user (generated by frontend).
...
Add a tune to the user's favorites.
...
Remove a tune from the user's favorites.
